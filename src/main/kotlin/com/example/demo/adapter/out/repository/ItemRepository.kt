...
interface ItemRepository : MongoRepository<ItemEntity, String> {
    fun findAllByOrderByCreatedInDesc(pageable: Pageable): Page<ItemEntity>
    fun findByCategoryOrderByCreatedInDesc(category: String, pageable: Pageable): Page<ItemEntity>
